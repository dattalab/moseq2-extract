...
This is only a debugging parameter, for cases where dilate_iterations > 1, otherwise has no effect. Either "auto" or an int value.')(function)
    ...
    function = click.option('--movie-dtype', default='<i2', help='Data type for raw frames read in for extraction')
    function = click.option('--pixel-format', default='gray16le', type=str, help='Pixel format for reading in .avi and .mkv videos')
