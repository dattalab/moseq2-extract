...
def process_extract_batches(h5_file, input_file, config_data, bground_im, roi,
                            scalars, frame_batches, first_frame_idx, str_els,
                            output_dir, output_filename, **kwargs):
    '''
