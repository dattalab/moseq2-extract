...
def write_image(filename, image, scale=True, scale_factor=None, img_dtype='uint16', compress=0):
    '''
    ...
    tifffile.imsave(file, image.astype(img_dtype), compress=compress, metadata=metadata)
