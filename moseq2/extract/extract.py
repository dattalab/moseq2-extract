from moseq2.extract.proc import crop_and_rotate_frames,\
 ...
 get_bground_im, get_flips, compute_scalars
...
def extract_chunk(chunk,use_em_tracker=False,prefilter_space=(3,),prefilter_time=None,
    ...
    if use_em_tracker:
        ...
        parameters=em_tracking(filtered_frames,rho_mean=rho_mean,rho_cov=rho_cov,progress_bar=progress_bar)
    ...
    cropped_frames=crop_and_rotate_frames(chunk,features,progress_bar=progress_bar)
    cropped_filtered_frames=crop_and_rotate_frames(filtered_frames,features,progress_bar=progress_bar)
    ...
    scalars=compute_scalars(cropped_filtered_frames,features,min_height,max_height)
